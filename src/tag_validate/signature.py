...
class SignatureDetector:
    ...
    async def detect_signature(self, tag_name: str) -> SignatureInfo:
        ...
        """
        logger.info(f"Detecting signature on tag: {tag_name}")
        ...
        try:
            ...
            if not verify_output or "no signature found" in verify_output.lower():
                logger.info(f"Tag {tag_name} is unsigned")
            ...
            if "BADSIG" in verify_output or "ERRSIG" in verify_output:
    ...
    async def _parse_invalid_gpg_signature(
        ...
        """
        Parse invalid GPG signature information.
        ...
        """
        logger.warning(f"Tag {tag_name} has invalid GPG signature")
